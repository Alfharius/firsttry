      ...
      <div className="flex flex-col gap-3 p-2 md:flex-row md:gap-4 md:p-3">
        ...
        <div className="flex-1 space-y-3 py-1">
          ...
          <div className="grid gap-x-6 gap-y-2 text-sm md:grid-cols-2">
            <p className="text-xl font-semibold text-slate-800">Тип</p>
            <p className="text-xl text-slate-800">{event.type}</p>

            <p className="text-xl font-semibold text-slate-800">Категория</p>
            <p className="text-xl text-slate-800">{event.category}</p>

            <p className="text-xl font-semibold text-slate-800">Место проведения</p>
            <p className="text-xl text-slate-800">{event.location}</p>

            <p className="text-xl font-semibold text-slate-800">Число участников</p>
          ...
          <div className="mt-6 border-t border-slate-300 pt-5">
            <div className="grid gap-2 text-sm md:grid-cols-3">
              <div className="md:col-span-2">
                <p className="mb-1 text-xl font-semibold text-slate-800">Даты проведения</p>
